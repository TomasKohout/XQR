...
$INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}test11.in --output=${LOCAL_OUT_PATH}test11.out --qf=${LOCAL_OUT_PATH}test11.qu --query='SELECT book FROM catalog' 2> ${LOG_PATH}test11.err
echo -n $? > test11.!!!
